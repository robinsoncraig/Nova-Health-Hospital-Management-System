...
<!-- Document Title -->
<title>NovaHealthcare Hospital Management System</title>

<!-- Favicon -->
<link rel="shortcut icon" href="images/nova.jpeg" type="image/x-icon">
<link rel="icon" href="images/nova.jpeg" type="image/x-icon">
...
<body>
  ...
  <header class="header-style-2">
    <div class="container">
      <div class="logo"> <a href="index.php"><img src="images/nova.jpeg" alt="" style="height: 51px;"></a> </div>
      <div class="head-info">
        <ul>
        <li> <i class="fa fa-phone"></i>
            <p>0795351999<br>
              Health Hospital Management System</p>
          </li>
          <li> <i class="fa fa-envelope-o"></i>
            <p>robinsoncraig454@gmail.com<br>
              info@health.com</p>
          </li>
