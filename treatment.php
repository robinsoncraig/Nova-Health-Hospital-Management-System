...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-sm-4 col-xs-12">
            <div class="form-group">
                ...
                <div class="form-line">
    <input type="text" class="form-control" name="treatmenttype" id="treatmenttype" value="<?php echo isset($rsedit['treatmenttype']) ? $rsedit['treatmenttype'] : ''; ?>">
</div>
        ...
        <div class="col-sm-4 col-xs-12">
            <div class="form-group">
                ...
                <div class="form-line">
    <input type="text" class="form-control" name="treatmentcost" id="treatmentcost" value="<?php echo isset($rsedit['treatment_cost']) ? $rsedit['treatment_cost'] : ''; ?>" />
</div>
                ...
                <div class="form-line">
                    <select name="status" id="status" class="form-control show-tick">
                        ...
                        foreach ($statusOptions as $val) {
                            $selected = ($val == $rsedit['status']) ? 'selected' : '';
    ...
    <div class="col-sm-12">
        <div class="form-group">
            ...
            <div class="form-line">
    <textarea name="note" class="form-control no-resize" id="note" cols="45" rows="5" placeholder="Enter your notes here..."><?php echo isset($rsedit['note']) ? $rsedit['note'] : ''; ?></textarea>
</div>
