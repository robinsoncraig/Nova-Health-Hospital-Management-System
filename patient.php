...
<div class="container-fluid">
    ...
    <div class="card">
        ...
        <form method="post" action="" name="frmpatient" onSubmit="return validateform()" style="padding: 10px">
            ...
            <div class="form-group"><label>Patient Name</label>
                <div class="form-line">
                <input class="form-control" type="text" name="patientname" id="patientname" value="<?php echo isset($rsedit['patientname']) ? $rsedit['patientname'] : ''; ?>" />
            </div>
            ...
            <div class="form-group"><label>Admission Date</label>
                <div class="form-line">
    <input class="form-control" type="date" name="admissiondate" id="admissiondate" value="<?php echo isset($rsedit['admissiondate']) ? $rsedit['admissiondate'] : ''; ?>" readonly />
</div>
            ...
            <div class="form-group"><label>Admission Time</label>
                <div class="form-line">
    <input class="form-control" type="time" name="admissiontme" id="admissiontme" value="<?php echo isset($rsedit['admissiontime']) ? $rsedit['admissiontime'] : ''; ?>" readonly />
</div>
            ...
            <div class="form-group">
                <label>Address</label>
                <div class="form-line">
    <input class="form-control" name="address" id="tinymce" value="<?php echo isset($rsedit['address']) ? $rsedit['address'] : ''; ?>">
</div>
    ...
    <input class="form-control" name="address" id="tinymce" value="<?php echo isset($rsedit['address']) ? $rsedit['address'] : ''; ?>">
            ...
            <div class="form-group"><label>City</label>
                <div class="form-line">
    <input class="form-control" type="text" name="city" id="city" value="<?php echo isset($rsedit['city']) ? $rsedit['city'] : ''; ?>" />
</div>
            ...
            <div class="form-group"><label>PIN Code</label>
                <div class="form-line">
    <input class="form-control" type="text" name="pincode" id="pincode" value="<?php echo isset($rsedit['pincode']) ? $rsedit['pincode'] : ''; ?>" />
</div>
    ...
    <div class="form-line">
        <select class="form-control show-tick" name="select2" id="select2">
            ...
            foreach ($bloodGroups as $group) {
                $selected = ($group == $rsedit['bloodgroup']) ? 'selected' : '';
    ...
    <div class="form-line">
        <select class="form-control show-tick" name="select3" id="select3">
            ...
            foreach ($genders as $gender) {
                $selected = ($gender == $rsedit['gender']) ? 'selected' : '';
