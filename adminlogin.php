...
<title>Nova Health Hospital Admin</title>
...
?></div>
    ...
    <div class="card">
        <h1 class="title"><span>Nova Health Hospital Management System</span>Login <span class="msg">Sign in to start your session</span></h1>
        <div class="col-md-12">
...
function validateform()
{
	...
	else if(document.frmadminlogin.password.value.length < 2)
	{
