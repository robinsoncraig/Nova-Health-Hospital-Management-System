...
?>
  &nbsp;KES <?php echo $billamt; ?></td>
		...
		<tr>
		  ...
		  <td>&nbsp;KES <?php echo $rsbilling_records['discount']; ?></td>
	    </tr>
        
		<tr>
		  <th rowspan="3" scope="col">&nbsp;</th>
		  <th scope="col"><div align="right">Grand Total &nbsp; </div></th>
		  <td>&nbsp;KES <?php echo $grandtotal = ($billamt + $taxamt)  - $rsbilling_records['discount'] ; ?></td>
	    </tr>
		<tr>
		...
		<tr>
		  ...
		  <td>KES <?php echo $balanceamt = $grandtotal - $rspayment[0]  ; ?></td>
	    </tr>
      </tbody>
    </table>
...
<?php       
		...
		?>
			   <tr>
				 ...
				 <td>&nbsp;KES <?php echo $rspayment['paidamount']; ?></td>
			   </tr>
		<?php
		}
?>
