            ...
            <div class="card">
                ...
                <form method="post" action="" name="frmdoctprfl" onSubmit="return validateform()" style="padding: 10px">
                    <div class="row">
                        ...
                        <div class="col-sm-4 col-xs-12">
                                <div class="form-group">
    <label for="select3">Department</label>
    <div class="form-line">
        <select name="select3" id="select3" class="form-control show-tick">
            ...
            if ($qsqldepartment) {
                while ($rsdepartment = mysqli_fetch_array($qsqldepartment)) {
                    $departmentId = $rsdepartment['departmentid'];
                    $departmentName = $rsdepartment['departmentname'];

                    // Use htmlspecialchars to prevent potential XSS attacks
                    $selected = ($departmentId == $rsedit['departmentid']) ? 'selected' : '';

                    echo "<option value='" . htmlspecialchars($departmentId, ENT_QUOTES) . "' $selected>" . htmlspecialchars($departmentName, ENT_QUOTES) . "</option>";
                }
            } else {
