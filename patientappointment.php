...
if(isset($_POST['submit'])) // Enclosed 'submit' in single quotes
{
...
if(isset($_GET['editid'])) // Enclosed 'editid' in single quotes
{
...
if(isset($_SESSION['patientid'])) // Enclosed 'patientid' in single quotes
{
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-7">
                            ...
                            ?>
                                        <li class="col-sm-6">
                                            <label>
    <select name="select6" id="select6" class="form-control">
        ...
        <select name="department" class="form-control" id="department">
            ...
            if (!$qsqldept) {
                die("Error: " . mysqli_error($con)); // Check for MySQL errors
            }
            ...
            ?>
                                        ...
                                        <li class="col-sm-6">
                                            <label>
    <select name="doct" id="department" class="form-control">
        ...
        ?>
                                        ...
                                        <li class="col-sm-6">
                                            <button type="submit" class="btn btn-primary btn-block" name="submit" id="submit">make an
                                                appointment</button>
                                        </li>
                                </form>
                            </div>
