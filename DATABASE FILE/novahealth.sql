...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 09, 2025 at 10:50 AM
...
(1, '', 1, 0, 1, '2025-03-09', '12:25:00', 2, 'Approved', '');
...
(1, 1, 1, '2025-03-09', '10:27:04', 0.00, 0.00, ' , ', '10:36:04', '2025-03-09');
...
(2, 'Beatrice Muriithi', '0765656556', 5, '47070350', '12345678', 'Active', 'Clinical Doctor', 5.0, 2000.00),
(6, 'Ruth Langat', '0765656556', 8, '911340798', '12345678', 'Active', 'Clinical Doctor', 5.0, 2000.00),
(21, 'Mary Odhiambo', '0765656556', 2, '37070350', '12345678', 'Active', 'Clinical Doctor', 5.0, 2000.00);
...
(13, 'Hydroxyurea', 550.00, 'used in sickle-cell disease, essential thrombocythemia, chronic myelogenous leukemia and cervical cancer', 'Active'),
...
(1, 'mulindi', '2025-03-09', '10:24:29', '50548', '0769946934', 'Nairobi', '', '37070350', '123456788', '', 'Male', '2016-02-09', 'Active');
...
(4, 15, 17, '2023-11-17', '15:41:39', 0.00, 'Active', '', 0, 0, '0000-00-00'),
(5, 1, 1, '2025-03-09', '10:36:10', 0.00, 'Active', '', 0, 0, '0000-00-00');
...
--
ALTER TABLE `prescription_records`
  MODIFY `prescription_record_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=32;
