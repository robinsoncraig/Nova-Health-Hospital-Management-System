    ...
    <table class="table table-hover">
        <tbody>
            <tr>
                ...
                <td width="66%">
                    <input placeholder="Enter Here" class="form-control" type="text" name="medicinename" id="medicinename" value="<?php echo isset($rsedit['medicinename']) ? htmlspecialchars($rsedit['medicinename']) : ''; ?>" />
                </td>
            </tr>
            ...
            <tr>
                ...
                <td width="66%">
                    <input placeholder="Enter Here" class="form-control" type="text" name="medicinecost" id="medicinecost" value="<?php echo isset($rsedit['medicinecost']) ? htmlspecialchars($rsedit['medicinecost']) : ''; ?>" />
                </td>
            </tr>
            ...
            <tr>
                <td>Description</td>
                <td>
                    <textarea placeholder="Enter Here" class="form-control no-resize" name="description" id="description" cols="45" rows="5"><?php echo isset($rsedit['description']) ? htmlspecialchars($rsedit['description']) : ''; ?></textarea>
                </td>
            </tr>
